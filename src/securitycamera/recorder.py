...
#     def __init__(self, identifier: str, *, width: int, height: int, framerate: int, debug: bool = False):
#         self._id = identifier
#
#         if debug:
...
#
#         last_element = self.build_jpeg_app_source(width, height, framerate)
#
...
#
#     def build_jpeg_app_source(self, width: int, height: int, framerate: int) -> Gst.Element:
